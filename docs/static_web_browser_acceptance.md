...
| Real MSM on Windows Chromium | OS/engine, reused | [#144 Windows acceptance](evidence/issue-144/windows-acceptance.json): Windows headless Chromium real MSM cold/warm calculation, provenance, no API fallback or crash on 2026-09-16. | Reuse for calculation feasibility; the #122 run still checks native desktop interaction and restart on the current Static origin. |
